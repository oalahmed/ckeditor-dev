...
* [#727](https://github.com/ckeditor/ckeditor-dev/issues/727): Fixed: custom styles might be invisible in [stylescombo](https://ckeditor.com/cke4/addon/stylescombo) plugin.
